...
HALF_TRACK   = 0.3   # Lx – half the distance between left and right wheels
HALF_BASE    = 0.3   # Ly – half the distance between front and rear axles

# ─── Limits ───────────────────────────────────────────────────────────────────
MAX_SPEED    = 0.5   # m/s (translation magnitude)
MAX_OMEGA    = 3.0   # rad/s (rotation)
WHEEL_RADIUS = 0.05  # metres – used to convert m/s → rad/s for the motor
